...
const routeColumns = computed(() => buildRouteColumns(isAllDayMode.value, stopBufferRadius.value > 0))

const stopColumns = computed(() => buildStopColumns(isAllDayMode.value, stopBufferRadius.value > 0))
...
const stopGeoAggregateColumns = computed(() => buildStopGeoAggregateColumns(isAllDayMode.value, bufferAggregationActive.value))

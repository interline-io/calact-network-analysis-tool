...
# TRANSITLAND_API_BASE=http://localhost:8080 yarn run calact wsdot --start-date 2025-10-13 --end-date 2025-10-19 --weekday-date 2025-10-14 --weekend-date 2025-10-19 --stop-buffer-radius 805 --bbox-name downtown-portland --table-dataset-name acsdt5y2023 --geo-dataset-name tiger2023 --geo-dataset-layer tract  --save-scenario-data public/examples/wsdot/downtown-portland.wsdot.json --report-name "Downtown Portland (2025 Transitland data; 2023 ACS)"